...
export default function Score({ setScreen }: any) {
  ...
  function saveHole() {
    ...
    const redNet = redScore - shots(Math.max(0, Number(redPlayer.handicap) - Number(bluePlayer.handicap)), selectedHole.si);
    const blueNet = blueScore - shots(Math.max(0, Number(bluePlayer.handicap) - Number(redPlayer.handicap)), selectedHole.si);
                  ...
                  style={
                    isCurrent
                      ? {
                          ...
                          boxShadow: `0 0 0 2px rgba(209,199,159,0.45), 0 0 20px rgba(209,199,159,0.75)`,
    ...
    <div className="flex flex-col items-center">
      <div
        className={cx(
          ...
          team === "red" ? "bg-gradient-to-b from-red-600 to-red-950" : "bg-gradient-to-b from-blue-500 to-blue-950"
        )}
      >
        {team === "red" ? "R" : "B"}
      </div>
